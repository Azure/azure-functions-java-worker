...
public class FunctionDefinitionTest {
	...
	public static void setClassLoaderProvider() throws Exception {
		...
		String targetPath = FunctionDefinitionTest.class.getProtectionDomain().getCodeSource().getLocation().getPath();
		File testJar = new File(targetPath + "/TestFunctionsClass.jar");
		functionClassLoaderProvider.addCustomerUrl(testJar.toURI().toURL());
	}

	@Test
    public void functionDefinition_one_method_buildSucceeds() throws Exception {
    ...
    public void functionDefinition_no_method_DoesnotExist() throws Exception {
    ...
    public void functionDefinition_multiple_methods_DuplicateAnnotations() throws Exception {
