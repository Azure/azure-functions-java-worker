...
public class RpcHttpRequestDataSourceTests {
	...
	public static RpcHttp getTestRpcHttp(Object inputBody) throws Exception {
		...
		RpcHttp.Builder httpBuilder = RpcHttp.newBuilder().setStatusCode(Integer.toString(HttpStatus.OK.value()));
	...
	private Method getFunctionMethod(String methodName) {
		...
		Class<? extends RpcHttpRequestDataSourceTests> httpDataSourceTestsClass = httpDataSourceTests.getClass();
