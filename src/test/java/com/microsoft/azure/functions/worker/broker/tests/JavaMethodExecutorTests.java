...
public class JavaMethodExecutorTests {
    ...
    public void functionMethodLoadSucceeds_8() throws Exception {
		...
		FunctionExecutionPayLoad payLoad = new FunctionExecutionPayLoad(descriptor, bindings, new FactoryClassLoader().createClassLoaderProvider());
    ...
    public void functionMethod_doesnotexist_LoadFails_8() throws Exception {
		...
		Map<String, BindingInfo> bindings = new HashMap<>();
		bindings.put("$return", BindingInfo.newBuilder().setDirection(BindingInfo.Direction.out).build());
		new FunctionExecutionPayLoad(descriptor, bindings, new FactoryClassLoader().createClassLoaderProvider());
	...
	public void functionMethodLoadSucceeds_11() throws Exception {
		...
		EnhancedJavaMethodExecutorImpl executor = new EnhancedJavaMethodExecutorImpl(descriptor, bindings, new FactoryClassLoader().createClassLoaderProvider());
