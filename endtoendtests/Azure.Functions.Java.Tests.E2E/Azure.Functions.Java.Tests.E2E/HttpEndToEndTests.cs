...
//        [InlineData("echo", "?&name=springcloudfunctionecho", HttpStatusCode.OK, "springcloudfunctionecho")]
//        [InlineData("uppercase", "?&name=springcloudfunctionuppercase", HttpStatusCode.OK, "SPRINGCLOUDFUNCTIONUPPERCASE")]
