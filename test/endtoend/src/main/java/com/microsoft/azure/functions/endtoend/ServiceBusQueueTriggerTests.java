...
public class ServiceBusQueueTriggerTests {
    ...
    public void serviceBusQueueTrigger(
        @ServiceBusQueueTrigger(name = "message", queueName = "mysbqueue", connection = "AzureServiceBus") String message,
    ...
    public void serviceBusQueueOutput(
        ...
        @ServiceBusQueueOutput(name = "output", queueName = "mysbqueue", connection = "AzureServiceBus") OutputBinding<String> output,
        final ExecutionContext context
    ) {
